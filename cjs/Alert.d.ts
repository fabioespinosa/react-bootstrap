...
> & {
  Link: import('@restart/ui/types').DynamicRefForwardingComponent<
    'a',
    import('./AlertLink').AlertLinkProps
  >;
  Heading: import('@restart/ui/types').DynamicRefForwardingComponent<
    'div',
    import('./AlertHeading').AlertHeadingProps
  >;
};
