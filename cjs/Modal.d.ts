...
declare const _default: React.ForwardRefExoticComponent<
  Omit<ModalProps, 'ref'> & React.RefAttributes<ModalHandle>
> & {
  Body: import('@restart/ui/types').DynamicRefForwardingComponent<
    'div',
  ...
  >;
  Title: import('@restart/ui/types').DynamicRefForwardingComponent<
    'span',
    import('./ModalTitle').ModalTitleProps
  >;
  Footer: import('@restart/ui/types').DynamicRefForwardingComponent<
    'div',
