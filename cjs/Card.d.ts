...
declare const _default: DynamicRefForwardingComponent<'div', CardProps> & {
  ...
  Title: DynamicRefForwardingComponent<
    'div',
    import('./CardTitle').CardTitleProps
  >;
  Subtitle: DynamicRefForwardingComponent<
    'div',
    import('./CardSubtitle').CardSubtitleProps
  >;
  Body: DynamicRefForwardingComponent<
    'div',
  ...
  Header: DynamicRefForwardingComponent<
    'div',
    import('./CardHeader').CardHeaderProps
  >;
  Footer: DynamicRefForwardingComponent<
    'div',
    import('./CardFooter').CardFooterProps
  >;
  ImgOverlay: DynamicRefForwardingComponent<
    'div',
