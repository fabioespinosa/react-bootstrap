...
declare const _default: DynamicRefForwardingComponent<'nav', NavbarProps> & {
  Brand: DynamicRefForwardingComponent<
    'a',
    import('./NavbarBrand').NavbarBrandProps
  >;
  Collapse: React.ForwardRefExoticComponent<
    import('./NavbarCollapse').NavbarCollapseProps &
      React.RefAttributes<HTMLDivElement>
  >;
  Offcanvas: React.ForwardRefExoticComponent<
    Omit<import('./NavbarOffcanvas').NavbarOffcanvasProps, 'ref'> &
      React.RefAttributes<import('@restart/ui/Modal').ModalHandle>
  >;
  Text: DynamicRefForwardingComponent<
    'span',
    import('./NavbarText').NavbarTextProps
  >;
  Toggle: DynamicRefForwardingComponent<
    'button',
