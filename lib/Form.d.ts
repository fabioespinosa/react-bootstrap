...
declare const _default: DynamicRefForwardingComponent<"form", FormProps> & {
    Group: DynamicRefForwardingComponent<"div", import("./FormGroup").FormGroupProps>;
    Control: DynamicRefForwardingComponent<"input", import("./FormControl").FormControlProps> & {
        Feedback: DynamicRefForwardingComponent<"div", import("./Feedback").FeedbackProps>;
    };
    Floating: DynamicRefForwardingComponent<"div", import("./FormFloating").FormFloatingProps>;
    Check: DynamicRefForwardingComponent<"input", import("./FormCheck").FormCheckProps> & {
    ...
    Switch: DynamicRefForwardingComponent<DynamicRefForwardingComponent<"input", import("./FormCheck").FormCheckProps> & {
        Input: DynamicRefForwardingComponent<"input", import("./FormCheckInput").FormCheckInputProps>;
        Label: React.ForwardRefExoticComponent<import("./FormCheckLabel").FormCheckLabelProps & React.RefAttributes<HTMLLabelElement>>;
    }, {
    ...
    Label: DynamicRefForwardingComponent<"label", import("./FormLabel").FormLabelProps>;
    Text: DynamicRefForwardingComponent<"small", import("./FormText").FormTextProps>;
    Range: React.ForwardRefExoticComponent<import("./FormRange").FormRangeProps & React.RefAttributes<HTMLInputElement>>;
    Select: React.ForwardRefExoticComponent<import("./FormSelect").FormSelectProps & React.RefAttributes<HTMLSelectElement>>;
    FloatingLabel: DynamicRefForwardingComponent<"div", import("./FloatingLabel").FloatingLabelProps>;
};
